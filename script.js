...
function init() {
  ...
  root.camera.position.set(0, 20, 60);
  ...
  root.scene.add(slide);
	...
	//-----
		...
		var slide4 = new Slide(width, height, 'out');
	var l4 = new THREE.ImageLoader();
	l4.setCrossOrigin('Anonymous');
	l4.load('./hk2', function(img) {
	  slide.setImage(img);
	})
  root.scene.add(slide);
  ...
  var tl = new TimelineMax({repeat:-1, repeatDelay:9.0, yoyo: true});
